...
<head>
    <meta charset="UTF-8">
    <title>Deactivate Member - Admin</title>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="content">
            <div class="page-header"><h1 class="page-title">Deactivate Member</h1></div>
            <div class="card">
            <?php
            $id = $_GET['id'] ?? 0;
            try {
                $stmt = $pdo->prepare("UPDATE members SET status='inactive' WHERE id=?");
                if($stmt->execute([$id])) echo "<div class='alert alert-success'>Member deactivated successfully. <a href='index.php'>Go back</a></div>";
