        ...
        <div class="content">
            ...
            <div class="card">
                <form class="search-bar" method="GET">
                    <input type="text" name="q" class="form-control" placeholder="Search by title, author, ISBN..." value="<?= htmlspecialchars($_GET['q'] ?? '') ?>">
                ...
                <table>
                    <thead>
                        <tr>
                            <th>ID</th><th>Title</th><th>Author</th><th>ISBN</th><th>Category</th><th>Avail/Total</th><th>Shelf</th><th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        try {
                            $q = $_GET['q'] ?? '';
                            $query = "SELECT b.*, c.name as category_name FROM books b LEFT JOIN categories c ON b.category_id = c.id WHERE title LIKE :q OR author LIKE :q OR isbn LIKE :q LIMIT 50";
