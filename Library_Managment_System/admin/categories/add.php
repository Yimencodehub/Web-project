...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="content">
            <div class="page-header"><h1 class="page-title">Add Category</h1><a href="index.php" class="btn btn-primary">Back</a></div>
            <?php
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                try {
                    $stmt = $pdo->prepare("INSERT INTO categories (name, description) VALUES (?, ?)");
                    if($stmt->execute([$_POST['name'], $_POST['description']])) echo "<div class='alert alert-success'>Category added!</div>";
