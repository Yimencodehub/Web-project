...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="content">
            <div class="page-header"><h1 class="page-title">Delete Category</h1></div>
            <div class="card">
            <?php
            $id = $_GET['id'] ?? 0;
            try {
                ...
                if($check->fetchColumn() > 0) {
                    echo "<div class='alert alert-danger'>Cannot delete category: Contains books.</div>";
                } else {
                    $del = $pdo->prepare("DELETE FROM categories WHERE id=?");
                    if($del->execute([$id])) echo "<div class='alert alert-success'>Category deleted. <a href='index.php'>Go back</a></div>";
                }
