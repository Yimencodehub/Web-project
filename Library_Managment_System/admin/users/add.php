...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="content">
            <div class="page-header"><h1 class="page-title">Add Staff/Admin</h1><a href="index.php" class="btn btn-primary">Back</a></div>
            <?php
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                try {
                    $stmt = $pdo->prepare("INSERT INTO users (username, email, password, role) VALUES (?, ?, ?, ?)");
                    if($stmt->execute([$_POST['username'], $_POST['email'], password_hash($_POST['password'], PASSWORD_DEFAULT), $_POST['role']])) echo "<div class='alert alert-success'>User added!</div>";
                } catch(Exception $e) { echo "<div class='alert alert-danger'>Error. Username or Email might exist.</div>"; }
            }
            ?>
